...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        labels_placeholder = tf.placeholder(tf.int32, shape=(Config.batch_size, Config.n_classes))
    ...
    def add_prediction_op(self):
        ...
        input_data = self.input_placeholder
        pred = softmax(tf.matmul(input_data, w) + b)
